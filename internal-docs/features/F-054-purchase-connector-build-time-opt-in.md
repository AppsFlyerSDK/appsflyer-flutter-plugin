...
Android (Gradle, evaluated at build configuration time):
  android/build.gradle
    ...
    sourceSets.main.java.srcDirs += includeConnector
        ...
        : ['src/main/exclude-connector']    → stub AppsFlyerPurchaseConnector.kt (no MethodChannel registered)
...
| `android/src/main/exclude-connector/com/appsflyer/appsflyersdk/AppsFlyerPurchaseConnector.kt` | No-op stub: implements `FlutterPlugin` but registers no `MethodChannel` at all |
