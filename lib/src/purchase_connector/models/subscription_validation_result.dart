...
class SubscriptionValidationResultMap{
  ...
  factory SubscriptionValidationResultMap.fromJson(Map<String, dynamic> json) => _$SubscriptionValidationResultMapFromJson(json);

  Map<String, dynamic> toJson() => _$SubscriptionValidationResultMapToJson(this);
}
