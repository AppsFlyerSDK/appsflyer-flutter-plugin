...
class DeveloperInitiatedCancellation {
  ...
  factory DeveloperInitiatedCancellation.fromJson(Map<String, dynamic> json) =>
      _$DeveloperInitiatedCancellationFromJson(json);
...
class ReplacementCancellation {
  ...
  factory ReplacementCancellation.fromJson(Map<String, dynamic> json) =>
      _$ReplacementCancellationFromJson(json);
...
class SystemInitiatedCancellation {
  ...
  factory SystemInitiatedCancellation.fromJson(Map<String, dynamic> json) =>
      _$SystemInitiatedCancellationFromJson(json);
...
class UserInitiatedCancellation {
  ...
  factory UserInitiatedCancellation.fromJson(Map<String, dynamic> json) =>
      _$UserInitiatedCancellationFromJson(json);
...
class CancelSurveyResult {
  ...
  factory CancelSurveyResult.fromJson(Map<String, dynamic> json) =>
      _$CancelSurveyResultFromJson(json);
...
class AutoRenewingPlan {
  ...
  AutoRenewingPlan(this.autoRenewEnabled, this.priceChangeDetails);

  factory AutoRenewingPlan.fromJson(Map<String, dynamic> json) =>
      _$AutoRenewingPlanFromJson(json);
...
class DeferredItemReplacement {
  ...
  factory DeferredItemReplacement.fromJson(Map<String, dynamic> json) =>
      _$DeferredItemReplacementFromJson(json);
...
class PrepaidPlan {
  ...
  factory PrepaidPlan.fromJson(Map<String, dynamic> json) =>
      _$PrepaidPlanFromJson(json);
...
class PausedStateContext {
  ...
  factory PausedStateContext.fromJson(Map<String, dynamic> json) =>
      _$PausedStateContextFromJson(json);
...
class TestPurchase {
  TestPurchase();
  factory TestPurchase.fromJson(Map<String, dynamic> json) =>
      _$TestPurchaseFromJson(json);
