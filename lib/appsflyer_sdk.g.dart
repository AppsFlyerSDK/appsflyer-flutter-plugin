...
SubscriptionPurchase _$SubscriptionPurchaseFromJson(
  ...
  (json['lineItems'] as List<dynamic>?)
      ?.map(
        (e) => SubscriptionPurchaseLineItem.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
...
DeferredItemReplacement _$DeferredItemReplacementFromJson(
  Map<String, dynamic> json,
) => DeferredItemReplacement(json['productId'] as String?);
...
PrepaidPlan _$PrepaidPlanFromJson(Map<String, dynamic> json) =>
    PrepaidPlan(json['allowExtendAfterTime'] as String?);

Map<String, dynamic> _$PrepaidPlanToJson(PrepaidPlan instance) =>
    <String, dynamic>{'allowExtendAfterTime': instance.allowExtendAfterTime};

PausedStateContext _$PausedStateContextFromJson(Map<String, dynamic> json) =>
    PausedStateContext(json['autoResumeTime'] as String?);

Map<String, dynamic> _$PausedStateContextToJson(PausedStateContext instance) =>
    <String, dynamic>{'autoResumeTime': instance.autoResumeTime};
